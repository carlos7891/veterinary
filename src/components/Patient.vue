...
<template>
  <div
    class="mx-5 my-10 bg-gray-50 border border-gray-300 text-gray-900 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white shadow-md px-5 py-10 rounded-xl"
  >
